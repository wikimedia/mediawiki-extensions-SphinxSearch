...
$messages['es'] = array(
	...
	'sphinxSearchPreamble' => "Mostrando %d-%d de %d coincidencias para la búsqueda de '''<nowiki>%s</nowiki>''', recuperado en %0.3f segundo(s) incluyendo estas estadísticas",
	'sphinxSearchStats' => "'''%s''' fue encontrado %d veces en %d documentos",
	...
	'sphinxSearchEpilogue' => 'El tiempo de base de datos adicional fue de %0.3f segundos.',
	...
	'sphinxPowered' => 'Potenciado por %s',
	'sphinxClientFailed' => 'No se pudo instanciar el cliente Sphinx',
	'sphinxSearchFailed' => 'Falló la búsqueda',
	'sphinxSearchWarning' => 'ADVERTENCIA',
);
...
$messages['fr'] = array(
	...
	'sphinxSearchPreamble' => "Affichage des résultats %d-%d sur %d pour la requête '''<nowiki>%s</nowiki>''' accomplie en %0.3f secondes avec ces statistiques",
	'sphinxSearchStats' => "'''%s''' trouvé %d fois dans %d documents",
	...
	'sphinxSearchEpilogue' => 'Le temps additionnel de la base de données était de %0.3f sec.',
	...
	'sphinxPowered' => 'Propulsé par %s',
	'sphinxClientFailed' => "Impossible d'instancier SphinxClient",
	'sphinxSearchFailed' => 'Échec de la requête',
	'sphinxSearchWarning' => 'AVERTISSEMENT',
);
...
$messages['gl'] = array(
	...
	'sphinxSearchPreamble' => "Mostrando %d-%d coincidencias dun total de %d que deu a pescuda \"'''<nowiki>%s</nowiki>'''\", obtidas en %0.3f segundos coas estatísticas",
	'sphinxSearchStats' => "\"'''%s'''\" atopouse %d veces en %d documentos",
	...
	'sphinxSearchEpilogue' => 'O tempo adicional da base de datos foi de %0.3f segundos.',
	...
	'sphinxLoading' => 'Cargando...',
	'sphinxPowered' => 'Desenvolvido por %s',
	'sphinxClientFailed' => 'Non se puido conectar co SphinxClient',
	'sphinxSearchFailed' => 'Fallou a pescuda',
...
$messages['no'] = array(
	...
	'sphinxSearchPreamble' => "Viser %d-%d av &d treff på søket '''<nowiki>%s</nowiki>''' hentet på %0.3f sek med disse statistikkene",
	'sphinxSearchStats' => "'''%s''' funnet %d ganger i %d dokument",
	...
	'sphinxSearchEpilogue' => 'Ytterligere databasetid var %0.3f sek.',
...
$messages['ru'] = array(
	...
	'sphinxSearchPreamble' => "Отображение %d—%d результатов из %d для запроса '''<nowiki>%s</nowiki>''', поиска занял %0.3f с",
	...
	'sphinxSearchEpilogue' => 'Дополнительное время базы данных составило %0.3f с.',
	...
	'sphinxPowered' => 'При поддержке %s',
	'sphinxClientFailed' => 'Невозможно создать экземпляр SphinxClient',
	'sphinxSearchFailed' => 'Ошибка при выполнении запроса',
	'sphinxSearchWarning' => 'ПРЕДУПРЕЖДЕНИЕ',
);
